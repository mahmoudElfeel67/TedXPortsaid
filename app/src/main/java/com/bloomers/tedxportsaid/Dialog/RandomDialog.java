    ...
    void onClick() {
        ...
        if (isArticle) {
            new FinestWebView.Builder(getActivity())
                    ...
                    .statusBarColor(AppController.easyColor(getActivity(), R.color.main_bacground_clolor))
                    .toolbarColor(AppController.easyColor(getActivity(), R.color.main_bacground_clolor))
