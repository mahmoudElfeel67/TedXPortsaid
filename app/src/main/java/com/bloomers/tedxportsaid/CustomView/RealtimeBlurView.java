...
public class RealtimeBlurView extends View {
    ...
    private void releaseBitmap() {
        ...
        if (mBitmapToBlur != null) {
            HeavilyUsed.saveToRecycle(mBitmapToBlur);
            mBitmapToBlur = null;
        }
        if (mBlurredBitmap != null) {
            HeavilyUsed.saveToRecycle(mBlurredBitmap);
            mBlurredBitmap = null;
        }
    }
    ...
    private boolean prepare() {
        if (mBlurRadius == 0 || Build.VERSION.SDK_INT == Build.VERSION_CODES.JELLY_BEAN) {
            release();
            return false;
        }
        ...
        if (mBlurringCanvas == null || mBlurredBitmap == null || mBlurredBitmap.getWidth() != scaledWidth || mBlurredBitmap.getHeight() != scaledHeight) {
            ...
            boolean r = false;
            try {
                mBitmapToBlur = Bitmap.createBitmap(scaledWidth, scaledHeight, Bitmap.Config.ARGB_4444);
                if (mBitmapToBlur == null) {
                    return false;
                }
                ...
                mBlurredBitmap = Bitmap.createBitmap(scaledWidth, scaledHeight, Bitmap.Config.ARGB_4444);
                if (mBlurredBitmap == null) {
                    return false;
                }
